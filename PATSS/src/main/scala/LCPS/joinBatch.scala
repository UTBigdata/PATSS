...
object joinBatch {
  def main(args: Array[String]): Unit = {
    ...
    //threshold: 0.5 - 0.9
    //parNum: 384
    println("----------------------------efficiency SZT-Nov & HZ LCPS join for all----------------------------")
    ...
    println("----------------------------scalability SZT-Nov & HZ LCPS join for all----------------------------")
    ...
    //threshold 0.8
    println("----------------------------scale up SZT-Nov & HZ LCPS join for all----------------------------")
    for(dataOri <- Array("/patss/SZT/all/SZT-2018Nov-100", "/patss/HZ/all/HZ-2019Jan-100")){
      println("——————————————————————————————————————————————————————————————————————")
    ...
    //coresNum 48-192
    //threshold 0.8
    println("----------------------------scale out SZT-Nov & HZ LCPS join for all----------------------------")
    ...
    //threshold: 0.5 - 0.9
    //parNum: 384
    println("----------------------------efficiency SZT-Nov-mini & HZ-Jan-mini LCPS join for DITA----------------------------")
    ...
    //dataSampleRate: 0.25 0.5 0.75 1.0
    //threshold: 0.8  parNum: 384
    println("----------------------------scalability SZT-Nov-mini & HZ-Jan-mini LCPS join for DITA----------------------------")
    ...
    //threshold 0.8
    println("----------------------------scale up SZT-Nov-mini & HZ-Jan-mini LCPS join for DITA----------------------------")
    for (dataOri <- Array("/patss/SZT/all/SZT-2018Nov-mini-100", "/patss/HZ/all/HZ-2019Jan-mini-100")) {
      println("——————————————————————————————————————————————————————————————————————")
      for (coresNum <- Range(48, 240, 16 * 3)) {
        val args = Array((coresNum * 2).toString, dataOri, "0.8", coresNum.toString, master)
    ...
    //coresNum 48-192
    //threshold 0.8
    println("----------------------------scale out SZT-Nov-L22 & HZ-Jan-L LCPS join for DITA----------------------------")
