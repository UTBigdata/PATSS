...
object searchBatch {
  def main(args: Array[String]): Unit = {
    ...
    //threshold: 0.5 - 0.9
    //parNum: 384
    println("============================efficiency SZT-Nov & HZ-Jan LCPS search============================")
    ...
    println("============================scalability SZT-Nov & HZ-Jan LCPS search============================")
    ...
    //coresNum 48-192
    //threshold 0.8
    println("============================scale up SZT-Nov & HZ-Jan LCPS search============================")
    for (dataOri <- Array("/patss/SZT/all/SZT-2018Nov-100", "/patss/HZ/all/HZ-2019Jan-100")) {
      println("——————————————————————————————————————————————————————————————————————")
    ...
    //coresNum 48-192
    //threshold 0.8
    println("============================scale out SZT-Nov & HZ-Jan LCPS search============================")
