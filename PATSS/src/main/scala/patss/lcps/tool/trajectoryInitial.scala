...
import patss.lcps.opt.{OD_Partitioner, heuristicPartition, neighborExpansion}
...
class trajectoryInitial {
  ...
  def start(staTraOri01:RDD[Array[String]],spark:SparkSession,parNum:String,path:String,tim:Timer,optPar:Boolean): (RDD[(Int, String)], DataFrame, DataFrame) = {
    ...
    val staTraOri13 = staTraOri01.map { tra: Array[String] =>
        // val tra = staTraOri0.take(10)(8) // 20181122 18:00:00.百鸽笼站.地铁五号线.I,20181122 18:10:00.长龙站.地铁五号线.I,20181122 18:20:00.百鸽笼站.地铁五号线.O,2018119:40:00.六约站.地铁三号线.O
    ...
    staTraOri13.rdd.setName("staTraOri13")
    staTraOri13.persist()
    ...
    traGlobal.rdd.setName("traGlobal")
    traGlobal.persist()
